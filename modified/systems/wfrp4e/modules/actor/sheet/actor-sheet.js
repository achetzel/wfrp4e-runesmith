...
export default class ActorSheetWfrp4e extends ActorSheet {
  ...
  constructItemLists(sheetData) {
    ...
    items.recipes = {
      basic: sheetData.actor.getItemTypes("rune").filter(i => i.data.data.strength.basic),
      master: sheetData.actor.getItemTypes("rune").filter(i => !i.data.data.strength.basic)
    }
